          ...
          <div class="col-9  text-right">
            ...
            <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
              <ul class="site-menu main-menu js-clone-nav ml-auto ">
                <li class="active"><a href="car_rent.php" class="nav-link">Home</a></li>
                <li><a href="login.php" class="nav-link">Add new Cars</a></li>
                <li><a href="available.php" class="nav-link">Available Cars to rent</a></li>
                <li><a href="login.php" class="nav-link">View Booked Cars</a></li>
            ...
            <div class="nonloop-block-13 owl-carousel">
              <div class="item-1">
                ...
                <div class="item-1-contents">
                  ...
                  <ul class="specs">
                    ...
                    <li>
                      <label for="rentDays">Number of days customer needs to rent:</label>
                      <select id="rentDays" name="rentDays" class="spec">
                      <option value="select">select</option>
                      </select>
                    </li>
                  </ul>
                  <div class="d-flex action">
                    <a href="login.php" class="btn btn-primary" id="rentCarButton">Rent Car</a>
                  </div>
                </div>
              </div>
              <div class="item-1">
                ...
                <div class="item-1-contents">
                  ...
                  <div class="d-flex action">
                    <a href="login.php" class="btn btn-primary" id="rentCarButton9">Rent Car</a>
                  </div>
                </div>
              </div>
              ...
              <div class="item-1">
                ...
                <div class="item-1-contents">
                  ...
                  <div class="d-flex action">
                    <a href="login.php" class="btn btn-primary" id="rentCarButton8">Rent Car</a>
                  </div>
                </div>
              </div>
              ...
              <div class="item-1">
                ...
                <div class="item-1-contents">
                  ...
                  <div class="d-flex action">
                    <a href="login.php" class="btn btn-primary" id="rentCarButton7">Rent Car</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="nonloop-block-13 owl-carousel">
              <div class="item-1">
                ...
                <div class="item-1-contents">
                  ...
                  <div class="d-flex action">
                    <a href="login.php" class="btn btn-primary" id="rentCarButton6">Rent Car</a>
                  </div>
                </div>
              </div>
              ...
              <div class="item-1">
                ...
                <div class="item-1-contents">
                  ...
                  <div class="d-flex action">
                    <a href="login.php" class="btn btn-primary" id="rentCarButton5">Rent Car</a>
                  </div>
                </div>
              </div>
              ...
              <div class="item-1">
                ...
                <div class="item-1-contents">
                  ...
                  <div class="d-flex action">
                    <a href="login.php" class="btn btn-primary" id="rentCarButton4">Rent Car</a>
                  </div>
                </div>
              </div>
              ...
              <div class="item-1">
                ...
                <div class="item-1-contents">
                  ...
                  <div class="d-flex action">
                    <a href="login.php" class="btn btn-primary" id="rentCarButton3">Rent Car</a>
                  </div>
                </div>
              </div>
              ...
              <div class="item-1">
                ...
                <div class="item-1-contents">
                  ...
                  <div class="d-flex action">
                    <a href="login.php" class="btn btn-primary" id="rentCarButton2">Rent Car</a>
                  </div>
                </div>
              </div>
              ...
              <div class="item-1">
                ...
                <div class="item-1-contents">
                  ...
                  <div class="d-flex action">
                    <a href="login.php" class="btn btn-primary" id="rentCarButton1">Rent Car</a>
                  </div>
                </div>
              </div>
            </div>
