    ...
    <body>
        <div class="dashboard-pg text-grey-blue bg-white fluid">
            <header class="site-navbar site-navbar-target" role="banner">
                ...
                <div class="container">
                    <div class="row align-items-center position-relative">
                        ...
                        <div class="col-3 ">
                            <div class="site-logo">
                                <a href="contact_agency.php">CarRent</a>
                            </div>
                        </div>
                        ...
                        <div class="col-9  text-right">
                            ...
                            <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                                    ...
                                    <li  class="active"><a href="contact_agency.php" class="nav-link">Contact</a></li>
            ...
            <div class="ftco-blocks-cover-1">
                <div class="ftco-cover-1 overlay" style="background-image: url('images/post_6.jpg')">
                    <div class="container">
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        ...
                                                        <table class="table table-striped table-hover" id="dataTable"
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    <th scope="col">Customers' First Name</th>
                                                                    <th scope="col">Customers' Last Name</th>
                                                                    <th scope="col">Customers' Email Address</th>
                                                                    <th scope="col">Customers' Message</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody id="myTable">
                                                                <?php
