                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-9">
                            <form class="p-4 bg-transparent" method="POST" action="php/create_user_apply.php">
                                ...
                                <div class="mb-1">
                                    <label for="name" class="form-label text-light">Agency Name</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control custom-input" id="role" name='role' value="car_rental_agency" readonly>
                                </div>
                                <!-- Submit button -->
